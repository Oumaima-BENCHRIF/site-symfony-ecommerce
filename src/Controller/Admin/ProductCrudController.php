...
class ProductCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            ImageField::new('illustration')->setLabel("Image")->setHelp("Image du produit en 60x60 px")->setUploadedFileNamePattern('[year]-[month]-[day]-[contenthash].[extension]')->setBasePath('uploads/')->setUploadDir("/public/uploads") ,
